...
const Storymap = () => {
  ...
  <Image src={Blue}></Image> */}
      <div className="MTASucks">
        <h1 id="yes" className="justify-content-center d-flex">
          ...
          <Row>
            <Col>
              <p className="justify-content-center d-flex">
                ...
                people NY rely on for everyday tasks, so the fact that it is
                even vaugely functional is a godsend. However, "vaugely
                functional" is barely good enough and places predominantly
                inhabitied by people of color seem to get the shortest of the
                already miniscule sticks from our beloved MTA.
                <br></br>
                Los Sures, Williamsburg happens to be a part of inarguably
                shafted locations, housing the reason why NYC is the most
                congested city in the world, the BQE, an 11.7 mile long roadway
                that takes any type of wheeled vehicle, including busses. And
                with the Williamsburg Bus Terminal, the last stop for 7 separate
                busses, sandwiched between an entrance and exit of the BQE,
                hold-ups are bound to happen.
                <br></br>
                "So, the busses are scuffed, but what about the trains? They
                can't be that bad." one might think, wishfully so. And you'd be
                right... kinda. It isn't the worst offender of trains (that
                title is still held by the C train), but it isn't a saint
                either. I calculated the average wait time of the J and M trains
                from Marcy Avenue during the times they gain the most traction;
                rush hour. Not the movie, the times between 8-9 am and 3-7 pm.
                The worst offender between the two is the M, with 5 &#189;
                minutes across 10 trains in the morning and 9 minutes across 30
                trains in the in the afternoon/evening. The real kicker with
                this one is the PM's rush hour time spread. This is the time
                where people wanna go home after work and school and having to
                wait 9 minutes at best case average, since the J and M stop at
                the same station track and can therefore cause delays for each
                other, it's awful. Even though the M is the true evil, that
                ...
                everywhere in NYC. It's a managed(?) system that works sometimes
                but we use it anyways. It's part of being a New Yorker, we're
                used to our messy, $2.90 (I still can't believe it's $2.90)
                fared form of transport that gets us almost everywhere in NYC.
                Almost. RIP the people in Staten Island. We still want it fixed,
                though.Don't take this as me saying it's fine, it really isn't
                but, I'd be remiss to say that I, along with many other New
                Yorkers haven't grown complaisant. Just because we're used to
                it, doesn't mean we like it. The fact that I had to wait and
                hour and 20 minutes for the B39, a bus that goes 3 whole stops
                in a ride that took a total of 5 minutes and I could have walked
                in like 30 minutes if the Maps app didn't consistantly lure me
                into a false sense of security, is a testiment to my disdain for
                the MTA. Fricken hate the B39.
              </p>
            </Col>
            <Col>
              <Image src={MTALogo}></Image>
            </Col>
          </Row>
        </Container>
      </div>
